<template>
  <div id="mainPage">
    <div style="width: 100%;height:300px;margin: 0 auto;">
      <codemirror style="font-size: 30px;width: 60%;height: 90%;margin:0 auto" class="code-edit" ref="mycode"
                  :value="curCode" :options="cmOptions"></codemirror>
    </div>
    <br>
    ...
    <br>
    <br>
    <textarea style="font-size:30px;margin-left:15%;width: 70%;height: 500px;" v-model="resultString" id="output"
              disabled
              placeholder="点击运行,输出的结果就会在这里显示啦;(没有变化的话，是不是忘记print了)"
...
import {onlineIDE} from "@/network/api/lesson"; // 这里引入的是主题样式，根据设置的theme的主题引入，一定要引入！！
